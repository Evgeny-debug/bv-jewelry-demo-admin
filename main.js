...
if (!localStorage.getItem('bv_demo_installed_v1')) {
    ...
    const demoCollage = {
        ...
        items: [
            ...
            { catId: 'crosses', title: 'Хрестики', img: 'https://images.unsplash.com/photo-1599643477877-530eb83abc8e?q=80&w=800' }
        ]
    };

    const demoSettings = {
        heroBg: 'https://images.unsplash.com/photo-1603561591411-071c4f75393c?q=80&w=1920',
